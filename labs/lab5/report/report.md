---
## Front matter
title: "Отчёт по лабораторной работе №5 Математическое моделирование"
subtitle: "Модель хищник-жертва. Вариант №31"
author: "Выполнил: Кузнецова София Вадимовна, НПИбд-02-22, 1132227132"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.45x(t) + 0.045y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.35y(t) - 0.035y(t)x(t)
 \end{cases}
$$
