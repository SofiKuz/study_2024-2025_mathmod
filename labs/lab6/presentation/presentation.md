...
## Задание лабораторной работы. Вариант 31
...
![График, построенный на языке OpenModelica](image/3.png){#fig:003}
...
![График, построенный на языке OpenModelica](image/4.png){#fig:004}
